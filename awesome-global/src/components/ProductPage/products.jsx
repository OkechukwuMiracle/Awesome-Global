...
const products = () => {
  ...
  return (
    <div className="pb-5 dark:bg-black overflow-hidden">
      ...
      <Navbar />
      <Menu />
      {/* Zealot Blutooth Speaker */}
      <div className="pt-5 mb-5">
        <h1 className="text-lg font-bold md:w-1/2 lg:w-1/4 p-2 text-center bg-blue-400 rounded-xl drop-shadow-xl">
        ...
        <div className="flex flex-wrap gap-5 justify-between w-11/12 mt-5 mx-auto">
          {zealotSpeakers.map((item) => (
            <div
              key={item.id}
              className="w-5/12 sm:w-1/4 md:w-1/4 rounded-lg border-gray-500 drop-shadow-md cursor-pointer"
            >
              <img
                src={item.image}
                alt={item.name}
      ...
      <div className="pt-5 ">
        <h1 className="text-lg font-bold  md:w-1/2 lg:w-1/4 py-2 bg-blue-400 text-center rounded-xl drop-shadow-xl">
          JBL Bluetooth Speaker
        </h1>
